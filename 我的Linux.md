...
```bash
# 插件
plugins=(git zsh-autosuggestions z zsh_reload)
# 主题
ZSH_THEME_RANDOM_CANDIDATES=( "xiong-chiamiov-plus" "agnoster" "half-life" "bira"  "gnzh" "simonoff" "funky" "amuse" "darkblood" "jonathan" "dpoggi" "duellj" )
# 主题模式
ZSH_THEME="random"
```
